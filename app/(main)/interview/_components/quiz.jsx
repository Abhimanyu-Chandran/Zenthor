...
const Quiz = () => {
    ...
    const {
        loading: generatingQuiz, fn: generateQuizFn, data: quizData,
    } = useFetch(generateQuiz);

    const {
        loading: savingResult, fn: saveQuizResultFn, data: resultData, setData: setResultData,
    ...
    return <Card className="mx-2">
        ...
        <CardFooter>
            ...
            <Button
                ...
                className="ml-auto"
            >
                {savingResult && (<Loader2 className="mr-4 h-4 w-4 animate-spin"/>)}
